...
<div align="center">
  <img src="final_task_demos/catch_marbles_trapdoors/default_head.gif" width="24%" />
  <img src="final_task_demos/cook_meat/default_head.gif" width="24%" />
  <img src="final_task_demos/whack_moles/default_head.gif" width="24%" />
  <img src="final_task_demos/save_goal/default_head.gif" width="24%" />
</div>
<div align="center">
  <img src="final_task_demos/boil_milk/success_head.gif" width="24%" />
  <img src="final_task_demos/catch_cup/success1_head.gif" width="24%" />
  <img src="final_task_demos/clean_table/success1_head.gif" width="24%" />
  <img src="final_task_demos/pour_beer/success_head.gif" width="24%" />
</div>
...
|---|---|---|---|---|
| **`catch_marbles_trapdoors`**<br><sub>Time the matching colored key press to drop the target marble through its trapdoor.</sub> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/default_head.gif" width="160" height="120"/><br><sub>Doors open 3 times only; no distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/opt1_head.gif" width="160" height="120"/><br><sub>Each door opens once; no distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/opt2_head.gif" width="160" height="120"/><br><sub>Reusable doors with a distractor marble.</sub></div> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/opt1+2_head.gif" width="160" height="120"/><br><sub>One-use doors with a distractor marble.</sub></div> |
...
| **`put_cup_belt`**<br><sub>Carry a cup through the workspace and place it in the slot between the tools.</sub> | <div align="center"><img src="final_task_demos/put_cup_belt/default_left_head.gif" width="160" height="120"/><br><sub>No curtains.</sub></div> | <div align="center"><img src="final_task_demos/put_cup_belt/opt1_left_head.gif" width="160" height="120"/><br><sub>Static blue curtains.</sub></div> | <div align="center"><img src="final_task_demos/put_cup_belt/opt2_left_head.gif" width="160" height="120"/><br><sub>Swaying blue curtains.</sub></div> | <div align="center"><img src="final_task_demos/put_cup_belt/opt1+2_left_head.gif" width="160" height="120"/><br><sub>Mix of static and moving curtains.</sub></div> |
...
Household scenes in office / kitchen environments. Each task shows two head-camera demos (success/failure or two successes); two tasks share a row so four demos sit on one line.

| Task | Demo | Demo | Task | Demo | Demo |
|---|---|---|---|---|---|
| **`trap_bug`**<br><sub>Trap a scurrying bug under the bookshelf with a glass box.</sub> | <div align="center"><img src="final_task_demos/trap_bug/success1_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | <div align="center"><img src="final_task_demos/trap_bug/success2_head.gif" width="140" height="105"/><br><sub>Success (seed 1)</sub></div> | **`catch_cup`**<br><sub>Push a pillow under a tipping mug so it lands softly.</sub> | <div align="center"><img src="final_task_demos/catch_cup/success1_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | <div align="center"><img src="final_task_demos/catch_cup/success2_head.gif" width="140" height="105"/><br><sub>Success (seed 1)</sub></div> |
| **`catch_mouse_object_drop`**<br><sub>Catch a shelf object knocked by a mouse with a pillow-lined basket.</sub> | <div align="center"><img src="final_task_demos/catch_mouse_object_drop/success_head.gif" width="140" height="105"/><br><sub>Success (seed 1)</sub></div> | <div align="center"><img src="final_task_demos/catch_mouse_object_drop/success2_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | **`stop_ball`**<br><sub>Block a falling table-tennis ball before it rolls off the table.</sub> | <div align="center"><img src="final_task_demos/stop_ball/success_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | <div align="center"><img src="final_task_demos/stop_ball/failure_head.gif" width="140" height="105"/><br><sub>Failure (seed 1)</sub></div> |
| **`clean_table`**<br><sub>Wipe a spreading coffee spill before it reaches a laptop.</sub> | <div align="center"><img src="final_task_demos/clean_table/success1_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | <div align="center"><img src="final_task_demos/clean_table/success2_head.gif" width="140" height="105"/><br><sub>Success (seed 1)</sub></div> | **`fill_coffee_jar`**<br><sub>Press the dispenser lid to fill a jar to the target line.</sub> | <div align="center"><img src="final_task_demos/fill_coffee_jar/success1_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | <div align="center"><img src="final_task_demos/fill_coffee_jar/success2_head.gif" width="140" height="105"/><br><sub>Success (seed 1)</sub></div> |
| **`pour_beer`**<br><sub>Pour beer to the line; foam ramps while held. Overflow fails.</sub> | <div align="center"><img src="final_task_demos/pour_beer/success_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | <div align="center"><img src="final_task_demos/pour_beer/failure_head.gif" width="140" height="105"/><br><sub>Failure (seed 7)</sub></div> | **`boil_milk`**<br><sub>Heat milk, then shut the stove off before it overflows.</sub> | <div align="center"><img src="final_task_demos/boil_milk/success_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | <div align="center"><img src="final_task_demos/boil_milk/failure_head.gif" width="140" height="105"/><br><sub>Failure (seed 3)</sub></div> |
| **`cook_food`**<br><sub>Drop food into a lit pan; shut off at the target doneness.</sub> | <div align="center"><img src="final_task_demos/cook_food/success_head.gif" width="140" height="105"/><br><sub>Success (seed 2)</sub></div> | <div align="center"><img src="final_task_demos/cook_food/success2_head.gif" width="140" height="105"/><br><sub>Success (seed 3)</sub></div> | **`cook_food_timer`**<br><sub>Same as cook_food, with a pie timer while the stove is on.</sub> | <div align="center"><img src="final_task_demos/cook_food_timer/success_head.gif" width="140" height="105"/><br><sub>Success (seed 3)</sub></div> | <div align="center"><img src="final_task_demos/cook_food_timer/success2_head.gif" width="140" height="105"/><br><sub>Success (seed 5)</sub></div> |
| **`make_soup`**<br><sub>Tip board vegetables into a pot on an already-lit stove.</sub> | <div align="center"><img src="final_task_demos/make_soup/success_head.gif" width="140" height="105"/><br><sub>Success (seed 2)</sub></div> | <div align="center"><img src="final_task_demos/make_soup/success2_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | **`measure_ingredient`**<br><sub>Fill a marked jar under an oil nozzle to the target ring.</sub> | <div align="center"><img src="final_task_demos/measure_ingredient/success1_head.gif" width="140" height="105"/><br><sub>Success (seed 0)</sub></div> | <div align="center"><img src="final_task_demos/measure_ingredient/success2_head.gif" width="140" height="105"/><br><sub>Success (seed 1)</sub></div> |
