...
Every task below has a side-by-side expert demonstration for each condition. The clips are converted
...
|---|---|---|---|---|
| **`catch_marbles_trapdoors`**<br><sub>Time the matching colored key press to drop the target marble through its trapdoor.</sub> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/default_sidebyside.gif" width="240" height="90"/><br><sub>≤3 door opens total; no distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Each door opens once; no distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/opt2_sidebyside.gif" width="240" height="90"/><br><sub>≤3 door opens total with a distractor marble.</sub></div> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>One-use doors with a distractor marble.</sub></div> |
| **`catch_ramp_ball`**<br><sub>Catch a red ball leaving a ramp in a cup without catching a distractor.</sub> | <div align="center"><img src="final_task_demos/catch_ramp_ball/default_sidebyside.gif" width="240" height="90"/><br><sub>Straight ramp exit; no distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_ramp_ball/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Ball rebounds from a wall.</sub></div> | <div align="center"><img src="final_task_demos/catch_ramp_ball/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Straight exit with a blue distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_ramp_ball/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Wall rebound with a blue distractor.</sub></div> |
| **`catch_cuboid`**<br><sub>Grasp the cuboid or cuboids during their timed pop-up windows.</sub> | <div align="center"><img src="final_task_demos/catch_cuboid/default_transparent_1cuboid_sidebyside.gif" width="240" height="90"/><br><sub>One cuboid; transparent board.</sub></div> | <div align="center"><img src="final_task_demos/catch_cuboid/opt1_catch_two_cuboids_sidebyside.gif" width="240" height="90"/><br><sub>Two simultaneous cuboids; transparent board.</sub></div> | <div align="center"><img src="final_task_demos/catch_cuboid/opt2_opaque_1cuboid_sidebyside.gif" width="240" height="90"/><br><sub>One cuboid; opaque board.</sub></div> | <div align="center"><img src="final_task_demos/catch_cuboid/opt1+2_catch_two_cuboids_opaque_sidebyside.gif" width="240" height="90"/><br><sub>Two simultaneous cuboids; opaque board.</sub></div> |
| **`catch_shelf_marble`**<br><sub>Slide a bowl along the belt to catch a marble rolling off tilted shelves.</sub> | <div align="center"><img src="final_task_demos/catch_shelf_marble/default_sidebyside.gif" width="240" height="90"/><br><sub>Marble waits for a bowl-key press.</sub></div> | <div align="center"><img src="final_task_demos/catch_shelf_marble/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Marble moves from episode start.</sub></div> | <div align="center"><img src="final_task_demos/catch_shelf_marble/opt2_sidebyside.gif" width="240" height="90"/><br><sub>One non-top shelf oscillates.</sub></div> | <div align="center"><img src="final_task_demos/catch_shelf_marble/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Immediate marble motion and an oscillating shelf.</sub></div> |
| **`catch_valley_ball`**<br><sub>Push an open box beyond the line to catch a red ball leaving a curved ramp.</sub> | <div align="center"><img src="final_task_demos/catch_valley_ball/default_sidebyside.gif" width="240" height="90"/><br><sub>Straight exit; no distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_valley_ball/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Red ball rebounds from a side rail.</sub></div> | <div align="center"><img src="final_task_demos/catch_valley_ball/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Straight exit with a black distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_valley_ball/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Wall rebound with a black distractor.</sub></div> |
| **`stop_valley_ball`**<br><sub>Hold a ping-pong bat mid-air so the red ball hits its circular head before falling to the table.</sub> | <div align="center"><img src="final_task_demos/stop_valley_ball/default_sidebyside.gif" width="240" height="90"/><br><sub>Straight exit; no distractor.</sub></div> | <div align="center"><img src="final_task_demos/stop_valley_ball/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Red ball rebounds from a side rail.</sub></div> | <div align="center"><img src="final_task_demos/stop_valley_ball/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Straight exit with a black distractor.</sub></div> | <div align="center"><img src="final_task_demos/stop_valley_ball/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Wall rebound with a black distractor.</sub></div> |
| **`cook_meat`**<br><sub>Cook steak on a pan to the target doneness with the cook key.</sub> | <div align="center"><img src="final_task_demos/cook_meat/default_sidebyside.gif" width="240" height="90"/><br><sub>One station; cook by pan contact.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat/opt1_sidebyside.gif" width="240" height="90"/><br><sub>One station; hold the cook key.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Two stations; cook by pan contact.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Two stations; each uses a cook key.</sub></div> |
| **`cook_meat_timer`**<br><sub>Cook steak with a pie timer (green→yellow→red) that tracks doneness.</sub> | <div align="center"><img src="final_task_demos/cook_meat_timer/default_sidebyside.gif" width="240" height="90"/><br><sub>One station; timer advances on pan contact.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat_timer/opt1_sidebyside.gif" width="240" height="90"/><br><sub>One station; timer runs while the cook key is held.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat_timer/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Two stations; contact cook with a pie timer each.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat_timer/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Two stations; each key holds its own pie timer.</sub></div> |
| **`put_cup_belt`**<br><sub>Carry a cup through the workspace and place it in the slot between the tools.</sub> | <div align="center"><img src="final_task_demos/put_cup_belt/default_left_sidebyside.gif" width="240" height="90"/><br><sub>No curtains.</sub></div> | <div align="center"><img src="final_task_demos/put_cup_belt/opt1_left_sidebyside.gif" width="240" height="90"/><br><sub>Static blue curtains.</sub></div> | <div align="center"><img src="final_task_demos/put_cup_belt/opt2_left_sidebyside.gif" width="240" height="90"/><br><sub>Swaying blue curtains.</sub></div> | <div align="center"><img src="final_task_demos/put_cup_belt/opt1+2_left_sidebyside.gif" width="240" height="90"/><br><sub>Curtains present and swaying.</sub></div> |
| **`dispense_gummy`**<br><sub>Operate a dispenser and moving bowl so only target-colored gummies are collected.</sub> | <div align="center"><img src="final_task_demos/dispense_gummy/default_sidebyside.gif" width="240" height="90"/><br><sub>Alternating layout; discrete bowl hops.</sub></div> | <div align="center"><img src="final_task_demos/dispense_gummy/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Randomized gummy layout; discrete bowl hops.</sub></div> | <div align="center"><img src="final_task_demos/dispense_gummy/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Alternating layout; continuous bowl motion.</sub></div> | <div align="center"><img src="final_task_demos/dispense_gummy/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Random layout and continuous bowl motion.</sub></div> |
| **`punch_dual_holes`**<br><sub>Use both arms to punch every present tile on two belts.</sub> | <div align="center"><img src="final_task_demos/punch_dual_holes/default_sidebyside.gif" width="240" height="90"/><br><sub>Discrete stops; both tiles present.</sub></div> | <div align="center"><img src="final_task_demos/punch_dual_holes/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Discrete stops with a missing tile.</sub></div> | <div align="center"><img src="final_task_demos/punch_dual_holes/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Continuous belt; both tiles present.</sub></div> | <div align="center"><img src="final_task_demos/punch_dual_holes/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Continuous belt with a missing tile.</sub></div> |
| **`save_goal`**<br><sub>Place the keeper before the deadline to block the ball from entering the goal.</sub> | <div align="center"><img src="final_task_demos/save_goal/default_sidebyside.gif" width="240" height="90"/><br><sub>Direct shot.</sub></div> | <div align="center"><img src="final_task_demos/save_goal/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Shot bounces off field players.</sub></div> | <div align="center"><img src="final_task_demos/save_goal/opt2_sidebyside.gif" width="240" height="90"/><br><sub>A mid-field cover briefly occludes the ball.</sub></div> | <div align="center"><img src="final_task_demos/save_goal/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Field-player bounce and a mid-field cover.</sub></div> |
| **`hit_target`**<br><sub>Use a stick to hit the moving target's yellow center while avoiding blockers.</sub> | <div align="center"><img src="final_task_demos/hit_target/default_sidebyside.gif" width="240" height="90"/><br><sub>Moving target only.</sub></div> | <div align="center"><img src="final_task_demos/hit_target/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Static green blocker.</sub></div> | <div align="center"><img src="final_task_demos/hit_target/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Dynamic red blocker.</sub></div> | <div align="center"><img src="final_task_demos/hit_target/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Static green and dynamic red blockers.</sub></div> |
| **`load_train`**<br><sub>Drop a ball into an allowed wagon of a continuously circling toy train.</sub> | <div align="center"><img src="final_task_demos/load_train/default_sidebyside.gif" width="240" height="90"/><br><sub>Any of three red wagons is allowed.</sub></div> | <div align="center"><img src="final_task_demos/load_train/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Only the nominated red wagon is allowed.</sub></div> | <div align="center"><img src="final_task_demos/load_train/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Any wagon is allowed; a far-arc tunnel is present.</sub></div> | <div align="center"><img src="final_task_demos/load_train/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Target wagon with a far-arc tunnel.</sub></div> |
| **`marble_shelf_maze`**<br><sub>Tilt shelves to route a marble through a zig-zag maze into the bowl.</sub> | <div align="center"><img src="final_task_demos/marble_shelf_maze/default_sidebyside.gif" width="240" height="90"/><br><sub>Paused marble and stationary bowl.</sub></div> | <div align="center"><img src="final_task_demos/marble_shelf_maze/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Continuously moving marble.</sub></div> | <div align="center"><img src="final_task_demos/marble_shelf_maze/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Paused marble and oscillating bowl.</sub></div> | <div align="center"><img src="final_task_demos/marble_shelf_maze/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Continuous marble motion and an oscillating bowl.</sub></div> |
| **`pack_fruits`**<br><sub>Pack red and green apples from belts into their matching baskets.</sub> | <div align="center"><img src="final_task_demos/pack_fruits/default_sidebyside.gif" width="240" height="90"/><br><sub>Single color; one basket; apples on either belt.</sub></div> | <div align="center"><img src="final_task_demos/pack_fruits/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Red and green with both baskets; one colored apple at a time.</sub></div> | <div align="center"><img src="final_task_demos/pack_fruits/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Single color with black distractor apple(s).</sub></div> | <div align="center"><img src="final_task_demos/pack_fruits/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Two colors with black distractor apple(s).</sub></div> |
| **`pick_ripe_apple`**<br><sub>Pick the good apple and place it in the basket while ignoring spoiled fruit.</sub> | <div align="center"><img src="final_task_demos/pick_ripe_apple/default_sidebyside.gif" width="240" height="90"/><br><sub>One good apple; static basket.</sub></div> | <div align="center"><img src="final_task_demos/pick_ripe_apple/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Good and spoiled apples; static basket.</sub></div> | <div align="center"><img src="final_task_demos/pick_ripe_apple/opt2_sidebyside.gif" width="240" height="90"/><br><sub>One good apple; oscillating basket.</sub></div> | <div align="center"><img src="final_task_demos/pick_ripe_apple/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Good and spoiled apples with an oscillating basket.</sub></div> |
| **`place_block_belt`**<br><sub>Place a top-heavy block onto a belt so it rides upright into the exit bowl.</sub> | <div align="center"><img src="final_task_demos/place_block_belt/default_sidebyside.gif" width="240" height="90"/><br><sub>Fixed bowl; clear belt lane.</sub></div> | <div align="center"><img src="final_task_demos/place_block_belt/opt1_moving_bowl_sidebyside.gif" width="240" height="90"/><br><sub>Moving bowl; clear belt lane.</sub></div> | <div align="center"><img src="final_task_demos/place_block_belt/opt2_blocker_sidebyside.gif" width="240" height="90"/><br><sub>Fixed bowl with a belt blocker.</sub></div> | <div align="center"><img src="final_task_demos/place_block_belt/opt1+2_moving_bowl_blocker_sidebyside.gif" width="240" height="90"/><br><sub>Moving bowl with a belt blocker.</sub></div> |
| **`play_billiard`**<br><sub>Strike the red ball into an allowed pocket without robot contact.</sub> | <div align="center"><img src="final_task_demos/play_billiard/default_sidebyside.gif" width="240" height="90"/><br><sub>Red ball only; any pocket is allowed.</sub></div> | <div align="center"><img src="final_task_demos/play_billiard/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Nominated target pocket.</sub></div> | <div align="center"><img src="final_task_demos/play_billiard/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Distractor balls; any pocket is allowed.</sub></div> | <div align="center"><img src="final_task_demos/play_billiard/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Nominated open pocket with distractors.</sub></div> |
| **`control_quality`**<br><sub>Stamp red and green tiles while skipping black outliers.</sub> | <div align="center"><img src="final_task_demos/control_quality/default_sidebyside.gif" width="240" height="90"/><br><sub>Alternating red and green tiles.</sub></div> | <div align="center"><img src="final_task_demos/control_quality/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Random red and green tile order.</sub></div> | <div align="center"><img src="final_task_demos/control_quality/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Alternating tiles with black outliers.</sub></div> | <div align="center"><img src="final_task_demos/control_quality/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Random tile order with black outliers.</sub></div> |
| **`drop_ball_hole`**<br><sub>Guide a ball through the target hole of a rotating sorter into the container below. Select `container_shape: cubic` or `cylinder`.</sub> | <div align="center"><img src="final_task_demos/drop_ball_hole/default_sidebyside.gif" width="240" height="90"/><br><sub>Regular surface; target hole only.</sub></div> | <div align="center"><img src="final_task_demos/drop_ball_hole/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Sticky surface; target hole only.</sub></div> | <div align="center"><img src="final_task_demos/drop_ball_hole/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Regular surface with a dummy hole.</sub></div> | <div align="center"><img src="final_task_demos/drop_ball_hole/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Sticky surface with a dummy hole.</sub></div> |
...
| **`whack_moles`**<br><sub>Strike randomized-speed moles with the mallets' flat faces without touching a rabbit.</sub> | <div align="center"><img src="final_task_demos/whack_moles/default_sidebyside.gif" width="240" height="90"/><br><sub>Two moles bob in fixed holes; no rabbit.</sub></div> | <div align="center"><img src="final_task_demos/whack_moles/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Fixed-hole moles with one rabbit distractor.</sub></div> | <div align="center"><img src="final_task_demos/whack_moles/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Unhit moles relocate after falling; no rabbit.</sub></div> | <div align="center"><img src="final_task_demos/whack_moles/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Relocating moles with one rabbit distractor.</sub></div> |
...
| **`catch_mouse_object_drop`**<br><sub>Place a pillow-lined basket under a shelf object knocked by a scurrying mouse so it does not hit the table.</sub> | <div align="center"><img src="final_task_demos/catch_mouse_object_drop/default_sidebyside.gif" width="320" height="120"/><br><sub>Office wall-shelf; mouse knock → basket catch.</sub></div> |
| **`stop_ball`**<br><sub>Grasp a table-tennis ball that falls from the shelf and rolls toward the near table edge.</sub> | <div align="center"><img src="final_task_demos/stop_ball/default_sidebyside.gif" width="320" height="120"/><br><sub>Office wall-shelf; grasp before the edge.</sub></div> |
...
| **`pour_beer`**<br><sub>Pull the draft-tap lever to pour beer into a mug; foam ramps while the tap stays open, and overflow fails.</sub> | <div align="center"><img src="final_task_demos/pour_beer/default_sidebyside.gif" width="320" height="120"/><br><sub>Bar counter; lever pour with foam control.</sub></div> |
| **`boil_milk`**<br><sub>Turn the stove on to boil milk, then shut it off when the milk reaches the red target ring without overflowing.</sub> | <div align="center"><img src="final_task_demos/boil_milk/default_sidebyside.gif" width="320" height="120"/><br><sub>KitchenS range; shut off at the red ring.</sub></div> |
| **`cook_food`**<br><sub>Drop meat, sausage, or onion into a pre-lit pan, then shut the stove off at the target doneness (food stays in the pan).</sub> | <div align="center"><img src="final_task_demos/cook_food/default_sidebyside.gif" width="320" height="120"/><br><sub>KitchenS stove; board → pan → shut off.</sub></div> |
| **`cook_food_timer`**<br><sub>Same as cook_food, with a pie timer that advances while the stove is on and freezes when it is off.</sub> | <div align="center"><img src="final_task_demos/cook_food_timer/default_sidebyside.gif" width="320" height="120"/><br><sub>KitchenS stove; pie timer tracks doneness.</sub></div> |
| **`make_soup`**<br><sub>Tip 2–4 distinct chopping-board vegetables into a pot of water on an already-lit stove without dropping any pieces.</sub> | <div align="center"><img src="final_task_demos/make_soup/default_sidebyside.gif" width="320" height="120"/><br><sub>KitchenS range; tip a random produce subset into the lit pot.</sub></div> |
| **`measure_ingredient`**<br><sub>Push a marked jar under an oil nozzle and fill it to the target ring; oil that misses the jar fails.</sub> | <div align="center"><img src="final_task_demos/measure_ingredient/default_sidebyside.gif" width="320" height="120"/><br><sub>Prep counter; push under nozzle, then fill.</sub></div> |
