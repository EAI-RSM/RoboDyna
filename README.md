...
| **pick_ripe_apple** | Two apples hang (L/R): one ripens green→**red**→black (pick); the other green→**yellow**→black (ignore). Basket oscillates under the branches; matching arm drops the red apple into it. | ✅ **done** | <img src="assets/static/demos/pick_ripe_apple.gif" width="320"/> |
