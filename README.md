...
| `catch_rat` | Grasp a rat that pops up from holes on a mid-table board spanning both arms; the owning-side arm must grip it while raised. Success = at least one catch. | <img src="assets/static/demos/catch_rat.gif" width="240"/> |
