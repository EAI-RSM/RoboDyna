...
| **`boil_milk`**<br><sub>Turn the stove on to boil milk, then shut it off as the milk reaches the rim without overflowing.</sub> | <div align="center"><img src="final_task_demos/boil_milk/default_sidebyside.gif" width="320" height="120"/><br><sub>KitchenS range; shut off before spill.</sub></div> |
| **`cook_food`**<br><sub>Cook meat, sausage, or onion on the stove to the target doneness, then plate it.</sub> | <div align="center"><img src="final_task_demos/cook_food/default_sidebyside.gif" width="320" height="120"/><br><sub>KitchenS stove; board → pan → plate.</sub></div> |
...
| **`measure_ingredient`**<br><sub>Open an oil dispenser to fill a marked jar to the target ring, then weigh the jar on a scale.</sub> | <div align="center"><img src="final_task_demos/measure_ingredient/default_sidebyside.gif" width="320" height="120"/><br><sub>Prep counter; pour, then place on scale.</sub></div> |
