...
|---|---|---|---|---|
| **`catch_marbles_trapdoors`**<br><sub>Time the matching colored key press to drop the target marble through its trapdoor.</sub> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/default_sidebyside.gif" width="240" height="90"/><br><sub>Reusable doors; no distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/opt1_sidebyside.gif" width="240" height="90"/><br><sub>Each door opens once; no distractor.</sub></div> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Reusable doors with a distractor marble.</sub></div> | <div align="center"><img src="final_task_demos/catch_marbles_trapdoors/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>One-use doors with a distractor marble.</sub></div> |
...
| **`cook_meat`**<br><sub>Cook steak on a pan to the target doneness and return it to the board.</sub> | <div align="center"><img src="final_task_demos/cook_meat/default_sidebyside.gif" width="240" height="90"/><br><sub>One station; cook by pan contact.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat/opt1_sidebyside.gif" width="240" height="90"/><br><sub>One station; hold the cook key.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Two stations; cook by pan contact.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Two stations; each uses a cook key.</sub></div> |
| **`cook_meat_timer`**<br><sub>Cook steak with a pie timer (green→yellow→red) that tracks doneness, then return it to the board.</sub> | <div align="center"><img src="final_task_demos/cook_meat_timer/default_sidebyside.gif" width="240" height="90"/><br><sub>One station; timer advances on pan contact.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat_timer/opt1_sidebyside.gif" width="240" height="90"/><br><sub>One station; timer runs while the cook key is held.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat_timer/opt2_sidebyside.gif" width="240" height="90"/><br><sub>Two stations; contact cook with a pie timer each.</sub></div> | <div align="center"><img src="final_task_demos/cook_meat_timer/opt1+2_sidebyside.gif" width="240" height="90"/><br><sub>Two stations; each key holds its own pie timer.</sub></div> |
...
| **`make_soup`**<br><sub>Tip chopping-board vegetables into a pot of water on an already-lit stove without dropping any pieces.</sub> | <div align="center"><img src="final_task_demos/make_soup/default_sidebyside.gif" width="320" height="120"/><br><sub>KitchenS range; tip board into lit pot.</sub></div> |
