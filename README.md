...
| **pick_ripe_apple** | One apple hangs from a left/right tree branch and ripens green→red→black; the matching arm picks it at red (detaches + freezes color) and drops it into a center breadbasket. | ✅ **done** | <img src="assets/static/demos/pick_ripe_apple.gif" width="320"/> |
