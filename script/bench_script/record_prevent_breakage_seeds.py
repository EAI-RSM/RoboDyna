#!/usr/bin/env python3
"""One-shot prevent_breakage recorder for fixed seeds (no infinite retry loop)."""
...
def record_seed(seed: int, config_name: str = "demo_dynamic") -> dict:
    ...
    final_dir = os.path.abspath("./final_task_demos/prevent_breakage/eval")
